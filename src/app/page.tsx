  ...
  return (
    <main className="max-w-4xl mx-auto px-6 py-24 md:py-48">
      ...
      <nav className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        >
          <span className="block text-[10px] uppercase tracking-widest text-muted font-mono mb-6">Metode 01</span>
          <h2 className="text-3xl font-bold mb-4 text-ink">Kartu Hafalan</h2>
          <p className="text-muted leading-relaxed mb-8">
            Perkuat ingatan konsep dasar melalui teknik repetisi aktif dengan kartu bolak-balik.
          </p>
          <span className="text-sm font-bold border-b border-ink pb-1">Buka Kartu &rarr;</span>
        </Link>
        ...
        <Link 
          ...
          className="group p-10 bg-white border border-transparent hover:border-gray-200 transition-all rounded-sm shadow-sm"
        >
          <span className="block text-[10px] uppercase tracking-widest text-muted font-mono mb-6">Metode 02</span>
          <h2 className="text-3xl font-bold mb-4 text-ink">Simulasi Ujian</h2>
          <p className="text-muted leading-relaxed mb-8">
            Uji kesiapanmu dengan soal pilihan ganda dan esai yang dinilai secara komprehensif.
          </p>
          <span className="text-sm font-bold border-b border-ink pb-1">Mulai Tes &rarr;</span>
        </Link>
      </nav>

      <footer className="mt-32 pt-12 border-t border-gray-100 flex justify-between items-center text-[10px] uppercase tracking-[0.2em] text-muted font-mono font-medium">
